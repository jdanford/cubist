...
fn find_1_empty() {
    ...
    assert_eq!(find(&words("b"), "", &cmp), Some(0..=0));
    assert_eq!(find(&words("c"), "", &cmp), Some(0..=0));
}
...
#[test]
fn find_2_empty() {
    assert_eq!(find(&words("a a"), "", &cmp), Some(0..=1));
    assert_eq!(find(&words("a b"), "", &cmp), Some(0..=1));
    assert_eq!(find(&words("a c"), "", &cmp), Some(0..=1));
    assert_eq!(find(&words("b b"), "", &cmp), Some(0..=1));
    assert_eq!(find(&words("b c"), "", &cmp), Some(0..=1));
    assert_eq!(find(&words("c c"), "", &cmp), Some(0..=1));
}
...
#[test]
fn find_3_empty() {
    assert_eq!(find(&words("a a a"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("a a b"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("a a c"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("a b b"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("a b c"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("a c c"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("b b b"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("b b c"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("b c c"), "", &cmp), Some(0..=2));
    assert_eq!(find(&words("c c c"), "", &cmp), Some(0..=2));
}
...
#[test]
fn find_4_empty() {
    assert_eq!(find(&words("a a a a"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a a a b"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a a a c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a a b b"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a a b c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a a c c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a b b b"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a b b c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a b c c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("a c c c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("b b b b"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("b b b c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("b b c c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("b c c c"), "", &cmp), Some(0..=3));
    assert_eq!(find(&words("c c c c"), "", &cmp), Some(0..=3));
}
